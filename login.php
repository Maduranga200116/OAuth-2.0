...
if(isset($_GET["code"]))
{
      //This will use to exchange a code for valid authentication token.
     $token = $google_auth_client->fetchAccessTokenWithAuthCode($_GET["code"]);

     //Below code will check the errors which occur during token authentication. 
     if(!isset($token['error']))
     {
        //Access token set to be used for requests
        $google_auth_client->setAccessToken($token['access_token']);

        //Access token value stored in a SESSION variable for later use
                ...
                <div class="logo mb-3">
                   ...
                   <form action="" method="post">
                           ...
                           <div class="col-md-12 mb-3">
                              <p class="text-center">
                                 <?php  
                                    // this button is used to call google_auth_client function                               
                                  ...
                                  <?php
                                    if ($login_button == '') 
                                    {
                                      //user will redirect to main page if loging button has a value
